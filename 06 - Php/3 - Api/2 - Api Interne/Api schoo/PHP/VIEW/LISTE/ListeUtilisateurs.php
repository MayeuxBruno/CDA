...
echo '<div class="caseListe grid-columns-span-9">Liste des Utilisateurs </div>';
...
echo '<div class="caseListe">Pseudo</div>';
...
echo '<div class="caseListe">'.$unObjet->getPseudo().'</div>';
