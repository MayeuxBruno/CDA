...
echo '<div class="caseListe grid-columns-span-4">Liste des Roles </div>';
...
echo '<div class="caseListe">libelleRole</div>';
...
{
echo '<div class="caseListe">'.$unObjet->getLibelleRole().'</div>';
