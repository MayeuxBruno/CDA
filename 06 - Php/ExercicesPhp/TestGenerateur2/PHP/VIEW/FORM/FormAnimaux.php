...
echo '<div class="caseForm">'.creerSelect(($mode == "Ajouter") ? 1 : $elm->getIdRegimeAlimentaire(),'regimesalimentaire',['libelleRegimeAlimentaire']).'</div>';
echo '<div class="caseForm"><i class="fas fa-question-circle"></i></div>';
echo '<div class="caseForm"><i class="fas fa-check-circle"></i></div>';
...
echo '<div class="caseForm">'.creerSelect(($mode == "Ajouter") ? 1 : $elm->getIdHabitat(),'habitats',['libelleHabitat']).'</div>';
echo '<div class="caseForm"><i class="fas fa-question-circle"></i></div>';
echo '<div class="caseForm"><i class="fas fa-check-circle"></i></div>';
