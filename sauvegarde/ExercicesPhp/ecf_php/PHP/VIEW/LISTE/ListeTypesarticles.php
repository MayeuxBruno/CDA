...
echo '<div class="caseListe titreListe grid-columns-span-4">Liste des Typesarticles </div>';
...
echo '<div class="caseListe labelListe">LibelleTypeArticle</div>';
...
{
echo '<div class="caseListe donneeListe">'.$unObjet->getLibelleTypeArticle().'</div>';
