...
echo '<div class="pad"><div class="caseListe labelListe">LibelleArticle</div></div>';
echo '<div class="pad"><div class="caseListe labelListe">DescriptionArticle</div></div>';
echo '<div class="pad"><div class="caseListe labelListe">PrixArticle</div></div>';
echo '<div class="pad"><div class="caseListe labelListe">IdTypeArticle</div></div>';
...
{
echo '<img class="caseListe donneeListe"src="IMG/'.$unObjet->getPhotos().'" alt="photoProduit"/>';
