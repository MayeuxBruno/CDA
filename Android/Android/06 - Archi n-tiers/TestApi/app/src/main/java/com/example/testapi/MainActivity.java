...
public class MainActivity extends AppCompatActivity {
    private Button btnListeModePaiement;

    // On déclare les variables dans la classe pour les récupérer plus facilmen
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnListeModePaiement = (Button) findViewById(R.id.btnListeModePaiement);
        Intent intModePaiement = new Intent(this,ModeDePaiement.class);
        btnListeModePaiement.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(intModePaiement);
            }
        });
