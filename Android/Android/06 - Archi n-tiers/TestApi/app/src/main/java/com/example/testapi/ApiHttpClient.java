...
public class ApiHttpClient {
    ...
    public String getData(String idModePaiement) {
        ...
        // On ajoute l'idModeDePaiement à l'url, s'il y a pas d'id, on ramène la liste
        url=BASE_URL + idModePaiement;
        Log.d("Test", "URL: "+url);
        try {
