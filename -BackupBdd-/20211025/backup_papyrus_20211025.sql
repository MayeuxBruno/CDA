...
INSERT INTO `entcom` VALUES (70010,'','2021-10-21 14:12:32',120),(70011,'Commande urgente','2021-10-21 14:12:32',540),(70020,'','2021-10-21 14:12:32',9120),(70025,'Commande urgente','2021-10-21 14:12:32',9150),(70210,'Commande cadencée','2021-10-21 14:12:32',120),(70250,'Commande cadencée','2021-10-21 14:12:32',8700),(70300,'','2021-10-21 14:12:32',9120),(70620,'','2021-10-21 14:12:32',540),(70625,'','2021-10-21 14:12:32',120),(70629,'','2021-10-21 14:12:32',9180);
...
/*!50001 VIEW `commandeslignes` AS select `e`.`numcom` AS `N° Commande`,`e`.`obscom` AS `Observations`,cast(`e`.`datcom` as date) AS `Date de commande`,`p`.`libart` AS `Article`,`l`.`qtecde` AS `Quantité`,`l`.`priuni` AS `Prix unitaire` from (((`entcom` `e` left join `ligcom` `l` on((`l`.`numcom` = `e`.`numcom`))) join `fournis` `f` on((`e`.`numfou` = `f`.`numfou`))) join `produit` `p` on((`l`.`codart` = `p`.`codart`))) */;
...
-- Dump completed on 2021-10-25 11:50:46
