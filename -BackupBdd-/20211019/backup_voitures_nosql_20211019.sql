...
--
-- Host: localhost    Database: voitures_nosql
-- ------------------------------------------------------
...
--
-- Current Database: `voitures_nosql`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `voitures_nosql` /*!40100 DEFAULT CHARACTER SET latin1 */;
